...
export default defineConfig({
  ...
  title: 'tsdevstack',
  description: 'Full-stack, cloud-native TypeScript framework for production microservices',
  themeConfig: {
    socialLinks: [
      {
        icon: 'github',
      ...
      '/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is tsdevstack?', link: '/introduction/what-is-tsdevstack' },
        ...
        },
        {
          ...
          items: [
            { text: 'Running Locally', link: '/local-development/running-locally' },
        ...
        },
        {
          text: 'Building APIs',
          items: [
            { text: 'OpenAPI Decorators', link: '/building-apis/openapi-decorators' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Protected Routes', link: '/authentication/protected-routes' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Docker Overrides', link: '/customization/docker-overrides' },
            { text: 'Kong Customization', link: '/customization/kong-customization' },
          ],
        },
        {
          text: 'Security',
          items: [
            { text: 'Compliance Readiness', link: '/security/compliance-readiness' },
          ],
        },
        {
          text: 'Infrastructure',
          items: [
            ...
            { text: 'Service Configuration', link: '/infrastructure/service-configuration' },
            ...
            { text: 'Domain Setup', link: '/infrastructure/domain-setup' },
            {
              ...
              items: [
                ...
                { text: 'Account Setup', link: '/infrastructure/providers/gcp/account-setup' },
                { text: 'Architecture', link: '/infrastructure/providers/gcp/architecture' },
                { text: 'DNS & Domains', link: '/infrastructure/providers/gcp/dns-and-domains' },
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Account Setup', link: '/infrastructure/providers/aws/account-setup' },
                { text: 'Architecture', link: '/infrastructure/providers/aws/architecture' },
                { text: 'DNS & Domains', link: '/infrastructure/providers/aws/dns-and-domains' },
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Account Setup', link: '/infrastructure/providers/azure/account-setup' },
                { text: 'Architecture', link: '/infrastructure/providers/azure/architecture' },
                { text: 'DNS & Domains', link: '/infrastructure/providers/azure/dns-and-domains' },
