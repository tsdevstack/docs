...
When running `npm run dev`, logs from all services appear in your terminal. For structured logging, metrics, and distributed tracing, see [Observability](/docs/features/observability).
