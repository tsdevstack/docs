...
- [Service Configuration — WAF Rules](/docs/infrastructure/service-configuration#waf-rules) for the full configuration reference
- [GCP Architecture](/docs/infrastructure/providers/gcp/architecture), [AWS Architecture](/docs/infrastructure/providers/aws/architecture), [Azure Architecture](/docs/infrastructure/providers/azure/architecture) for provider-specific WAF details
- [Compliance Readiness](/docs/security/compliance-readiness) for how WAF maps to compliance frameworks
