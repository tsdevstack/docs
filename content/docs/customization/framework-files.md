...
Not every key follows simple concatenation. Kong's merge is structured per key — see [Kong Customization](/docs/customization/kong-customization) for details.
...
See [Escape Hatches](/docs/customization/escape-hatches) for details on when and how to use these overrides.
