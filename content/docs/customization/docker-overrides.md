...
:::tip
For inter-service messaging, use the built-in [Async Messaging](/docs/features/async-messaging) feature (Redis Streams) instead of adding a separate message broker. For background jobs, use the built-in BullMQ integration.
:::
