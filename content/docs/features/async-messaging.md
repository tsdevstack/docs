...
For full API reference (`MessagingModule`, `@OnMessage`, `MessagingService`, `IncomingMessage`), see the [nest-common package reference](/docs/packages/nest-common#messaging).
