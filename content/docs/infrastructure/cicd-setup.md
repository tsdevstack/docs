...
- [Azure Account Setup](/docs/infrastructure/providers/azure/account-setup) — App Registration, Resource Group, Permissions
- [GCP Account Setup](/docs/infrastructure/providers/gcp/account-setup) — Project, Service Account
- [AWS Account Setup](/docs/infrastructure/providers/aws/account-setup) — Account, IAM User
...
- [GCP CI/CD](/docs/infrastructure/providers/gcp/cicd) - Workload Identity Federation setup
- [AWS CI/CD](/docs/infrastructure/providers/aws/cicd) - IAM role setup
- [Azure CI/CD](/docs/infrastructure/providers/azure/cicd) - Federated credentials setup
...
- [AWS CI/CD — User Secrets](/docs/infrastructure/providers/aws/cicd#user-secrets-required-before-first-deployment)
- [GCP CI/CD — User Secrets](/docs/infrastructure/providers/gcp/cicd#user-secrets-required-before-first-deployment)
- [Azure CI/CD — User Secrets](/docs/infrastructure/providers/azure/cicd#user-secrets-required-before-first-deployment)
