...
This page covers the cloud deployment architecture. For conceptual architecture and request flows, see [Architecture Overview](/docs/introduction/architecture-overview).
...
| Object Storage | Cloud Storage / S3 / Azure Blob | Per-bucket, private access |
...
| Object Storage | None | Private VPC only |
...
- See [Object Storage](/docs/features/object-storage) for details
...
| Object Storage | MinIO container | Cloud-native (GCS/S3/Azure Blob) |
