...
Complete [Account Setup](/docs/infrastructure/providers/gcp/account-setup) first. You need a service account with roles already configured before setting up CI/CD.
...
2. Click on your deploy service account (don't see one? Complete [Account Setup](/docs/infrastructure/providers/gcp/account-setup) first)
...
If you have local credentials configured (see [Account Setup](/docs/infrastructure/providers/gcp/account-setup)), you can push all user secrets from your machine:
...
- Grant only the required roles to the deploy service account (see [Account Setup](/docs/infrastructure/providers/gcp/account-setup))
