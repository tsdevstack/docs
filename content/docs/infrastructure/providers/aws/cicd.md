...
If you have local credentials configured (see [Account Setup](/docs/infrastructure/providers/aws/account-setup)), you can push all user secrets from your machine:
