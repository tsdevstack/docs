...
Terraform files are generated per environment. See [Infrastructure](/docs/infrastructure/architecture) for details.
...
The three-file merge strategy ensures your customizations persist across framework updates. See [Local Secrets](/docs/secrets/local-secrets) for more.
