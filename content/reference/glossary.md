...
| **Bucket** | An object storage container for files. [MinIO](https://min.io/) locally, S3 (AWS), Cloud Storage (GCP), or Blob Storage (Azure) in the cloud. Added via `add-bucket-storage`. See [Object Storage](/features/object-storage). |
