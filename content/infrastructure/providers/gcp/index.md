...
:::info Cost
tsdevstack is free and open source — there are no license fees. You only pay Google directly for the cloud resources. See [GCP Cost Estimation](/infrastructure/providers/gcp/cost-estimation) for a full breakdown by scenario.
:::
...
3. [Cost Estimation](/infrastructure/providers/gcp/cost-estimation) — What you'll pay Google (dev, prod, scaled)
4. [DNS & Domains](/infrastructure/providers/gcp/dns-and-domains) — Configure custom domains and SSL
5. [CI/CD](/infrastructure/providers/gcp/cicd) — Set up Workload Identity Federation for GitHub Actions
